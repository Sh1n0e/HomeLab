...
Below is the docker compose file I will be using when installing it on a node in my proxmox cluster.
```yaml
services:
...
Once I run this, I can then create a proxy on nginx to make it easier to access with SSL certificate.